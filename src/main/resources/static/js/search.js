...
function autocomplete(inp, countries, names) {
    ...
    inp.addEventListener("input", function (e) {
        ...
        for (i = 0; i < countries.length; i++) {
            ...
            if (countries[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                ...
                b.style.backgroundImage = "url('/images/lct.png')";
        ...
        for (i = 0; i < names.length; i++) {
            ...
            if (names[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                ...
                b.style.backgroundImage = "url('/images/ks.png')";
                // b.style.backgroundSize = "cover";
                b.style.backgroundRepeat = "no-repeat";
                b.style.color = "green";
                /*execute a function when someone clicks on the item value (DIV element):*/
